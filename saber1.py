...
class Saber1(object):
	...
	def __init__(self):
		...
		# ((saberorigin x,y,z),(sabered x,y,z)			
	...
	def Acc(self,accX,accY,accZ):
		...
		self.centerX += accX *1000
		self.centerY += accY *1000
	...
	def Change(self,angleX,angleY,angleZ):
		...
		for v in self.saber:
				...
				#print "Draw : ",self.centerX,self.centerY
	...
	def Draw(self,f):
		...
		f.PolyLineOneColor(self.laspoints, 0xFF0000,True)
